...
namespace SignalRApiMssql.Models
{
    public class VisitorService
    {
        ...
        public List<VisitorChart> GetVisitorChartList()
        {
            ...
            {
                command.CommandText = "select tarih,[1],[2],[3],[4],[5] from (select Cast([VisitDate] as Date) as tarih,[City],CityVisitCount from Visitors) as visitTable Pivot(sum(CityVisitCount) For City in ([1],[2],[3],[4],[5])) as pivottable order by tarih asc";
